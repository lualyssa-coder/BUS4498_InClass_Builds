...
- **Next task or recipient:** If an attendance risk is identified, T8 Recommend organizer actions. If no attendance risk is identified, T9 Review forecast and recommendations.
