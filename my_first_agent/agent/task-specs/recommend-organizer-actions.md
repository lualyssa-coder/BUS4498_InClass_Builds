...
- **Output:** Relevant attendance, capacity, event, and registration information needed to assess risk and support recommendations, plus any missing or conflicting information.
...
- **Output:** Attendance risk findings, including any identified capacity or attendance risk and any comparison that remains uncertain because of missing or conflicting information.
